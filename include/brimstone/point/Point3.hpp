...
//Macros
#define BS_POINT3_DECLARE_INHERITED_METHODS( className, spec2 )             \
    BS_POINT_DECLARE_INHERITED_METHODS( className, 3, spec2 )               \
    className( const T x, const T y, const T z );
#define BS_POINT3_DEFINE_INHERITED_METHODS( className, tmpl, spec, spec2 )  \
