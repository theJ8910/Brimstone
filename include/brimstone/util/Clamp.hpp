...
Description:
    ...
    WARNING:
        In order for the function to work properly, lowerBound must be less than or equal to upperBound.
...
Description:
    ...
    NOTE:
        The actual and ideal names have no real significance to how the function operates; they were simply chosen arbitarily to tell the two values apart.
