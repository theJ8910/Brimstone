...
Description:
    Unit tests for Matrix (generic case; i.e. rectangular matrices)
*/
...
namespace {
    typedef ::Brimstone::Matrix< int, 5, 4 >   Matrix5x4i;
    typedef ::Brimstone::Matrix< float, 5, 4 > Matrix5x4f;
    typedef ::Brimstone::Matrix< int, 4, 5 >   Matrix4x5i;
