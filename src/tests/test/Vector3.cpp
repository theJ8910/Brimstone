...
UT_TEST_BEGIN( Vector3_getNormal_int )
    Vector3i o1( cv_values );
    Vector3i o2 = o1.getNormal();

    return allEqual( o2.data, cv_unit );
UT_TEST_END()

UT_TEST_BEGIN( Vector3_getNormal_float )
    Vector3f o1( cv_valuesAltF );
    Vector3f o2 = o1.getNormal();
...
UT_TEST_BEGIN( Vector3_typecastPoint )
    Vector3i o( cv_values );
    Point3i p( cv_valuesAlt );
...
UT_TEST_BEGIN( Vector3_typecastPoint_const )
    const Vector3i o( cv_values );
    Point3i p( cv_valuesAlt );
...
UT_TEST_BEGIN( Vector3_point_sub_point )
    Point3i  pt1( cv_arithmetic1 );
    Point3i  pt2( cv_arithmetic2 );
    Vector3i o(  cv_values      );
...
UT_TEST_BEGIN( Vector3_point_add_vec )
    Point3i  pt1( cv_arithmetic1 );
    Vector3i o(   cv_arithmetic2 );
    Point3i  pt2( cv_values );
...
UT_TEST_BEGIN( Vector3_vec_add_point )
    Vector3i o(   cv_arithmetic1 );
    Point3i  pt1( cv_arithmetic2 );
    Point3i  pt2( cv_values );
...
UT_TEST_BEGIN( Vector3_point_sub_vec )
    Point3i  pt1( cv_arithmetic1 );
    Vector3i o(   cv_arithmetic2 );
    Point3i  pt2( cv_values );
...
UT_TEST_BEGIN( Vector3_invert_free )
    Vector3f o( cv_valuesF );
    Vector3f o2( cv_valuesAltF );
...
UT_TEST_BEGIN( Vector3_normalize_divByZero )
    Vector3i o1( cv_zero );
    try {
        o1.normalize();
        return false;
...
UT_TEST_BEGIN( Vector3_divAssign_vector_divByZero )
    Vector3i o1( cv_values );
    Vector3i o2( cv_zero );
...
UT_TEST_BEGIN( Vector3_divAssign_scalar_divByZero )
    Vector3i o( cv_values );
...
UT_TEST_BEGIN( Vector3_div_vector_divByZero )
    Vector3i o1( cv_values );
    Vector3i o2( cv_zero );
    Vector3i o3;
...
UT_TEST_BEGIN( Vector3_div_scalar_divByZero )
    Vector3i o1( cv_values );
    Vector3i o2;
...
UT_TEST_BEGIN( Vector3_invert_divByZero )
    Vector3f o( cv_zeroF );
...
UT_TEST_BEGIN( Vector3_invert_free_divByZero )
    Vector3f o1( cv_zeroF );
    Vector3f o2;
